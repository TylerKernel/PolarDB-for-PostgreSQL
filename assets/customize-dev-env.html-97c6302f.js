import{_ as r,r as o,o as c,c as d,a as s,b as n,d as a,w as l,e as p}from"./app-eb0c2f94.js";const m={},v=s("h1",{id:"定制开发环境",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#定制开发环境","aria-hidden":"true"},"#"),n(" 定制开发环境")],-1),u=s("h2",{id:"自行构建开发镜像",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#自行构建开发镜像","aria-hidden":"true"},"#"),n(" 自行构建开发镜像")],-1),b={href:"https://hub.docker.com/r/polardb/polardb_pg_devel/tags",target:"_blank",rel:"noopener noreferrer"},k=s("code",null,"polardb/polardb_pg_devel",-1),g=s("code",null,"linux/amd64",-1),h=s("code",null,"linux/arm64",-1),_={href:"https://hub.docker.com/_/ubuntu/tags",target:"_blank",rel:"noopener noreferrer"},f=s("code",null,"ubuntu:20.04",-1),S=p(`<details class="custom-container details"><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> ubuntu:20.04</span>
...
`)])])],-1),D=p(`<p>源码下载完毕后，使用 <code>sudo</code> 执行源代码根目录下的依赖安装脚本 <code>install_dependencies.sh</code> 自动完成所有的依赖安装。如果有定制的开发需求，请自行修改 <code>install_dependencies.sh</code>。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> PolarDB-for-PostgreSQL
<span class="token function">sudo</span> ./install_dependencies.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function w(O,L){const e=o("ExternalLinkIcon"),i=o("CodeGroupItem"),t=o("CodeGroup");return c(),d("div",null,[v,u,s("p",null,[n("DockerHub 上已有构建完毕的开发镜像 "),s("a",b,[k,a(e)]),n(" 可供直接使用（支持 "),g,n(" 和 "),h,n(" 两种架构）。")]),s("p",null,[n("另外，我们也提供了构建上述开发镜像的 Dockerfile，从 "),s("a",_,[n("Ubuntu 官方镜像"),a(e)]),n(),f,n(" 开始构建出一个安装完所有开发和运行时依赖的镜像，您可以根据自己的需要在 Dockerfile 中添加更多依赖。以下是手动构建镜像的 Dockerfile 及方法：")]),S,s("p",null,[n("PolarDB for PostgreSQL 的代码托管于 "),s("a",E,[n("GitHub"),a(e)]),n(" 上，稳定分支为 "),N,n("。如果因网络原因不能稳定访问 GitHub，则可以访问 "),s("a",P,[n("Gitee 国内镜像"),a(e)]),n("。")]),a(t,null,{default:l(()=>[a(i,{title:"GitHub"},{default:l(()=>[y]),_:1}),a(i,{title:"Gitee 国内镜像"},{default:l(()=>[R]),_:1})]),_:1}),D])}const x=r(m,[["render",w],["__file","customize-dev-env.html.vue"]]);export{x as default};
